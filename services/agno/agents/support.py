...
_tools: list = [confirm_payment, log_support_ticket, escalate_to_human, save_contact, save_company, log_conversation, save_chat_to_directus, save_chat_to_knowledge]
